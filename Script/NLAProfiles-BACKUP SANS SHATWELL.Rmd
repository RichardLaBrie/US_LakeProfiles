...
Binforest07.hot$Transp.index = Binforest07.hot$secchi_m / Binforest07.hot$depthmax_m
...
Binforest12.hot$Transp.index = Binforest12.hot$secchi_m / Binforest12.hot$depthmax_m
...
confusionMatrix(rf.bt0712, BF0712[test0712,"Binhypo"]) #0.8726
...
predicted.classes <- as.factor(ifelse(probabilities > 0.5, "1", "0"))
observed.classes <- testdata$Binhypo
confusionMatrix(predicted.classes, observed.classes) #0.8889
summary(step.logreg)
# par(mfrow=c(1,3))
...
set.seed(101)
train0712 = sample(1:nrow(BF0712.back), 0.7*nrow(BF0712.back))
test0712 = which(!1:nrow(BF0712.back) %in% train0712)

BF0712.lasso = BF0712.back
BF0712.lasso[,22] = as.numeric(BF0712.lasso[,22])-1
...
# Model accuracy rate
observed.classes <- testdata$Binhypo
mean(predicted.classes == observed.classes) #0.81
coef(lasso.model)
...
BF0712.hot$Dynamic = sqrt(BF0712.hot$area_km2)/BF0712.hot$lMeanDepth
...
#SMOTED
train0712.smote = smote(Binhypo~., data=BF0712.hot[train0712,],perc.under = 1.5)
rf.bh0712.hot.smote = randomForest(Binhypo~., train0712.smote, localImp = TRUE, ntree=1000)
rf.bt0712.hot.smote = predict(rf.bh0712.hot.smote, newdata = BF0712.hot[test0712,])
confusionMatrix(rf.bt0712.hot.smote, BF0712.hot[test0712,"Binhypo"]) #0.766
...
full.logreg.hot <- glmnet(resp.train ~., data = traindata[,-21], family = binomial)
...
Okham.logreg.hot <- glm(resp.train ~basinarea_km2 +secchi_m + pct_agric + Transp.index + Julian.day, data = traindata[,-21], family = binomial)
...
HTpred = c("lat", "lon","area_km2", "elevation_m", "basinarea_km2", "chla_ugL", "NTL_umolL", "PTL_umolL", "DOC_umolL", "secchi_m", "color_PCU","WALA_ratio", "pct_forest", "pct_agric",  "nutrient_color", "Transp.index", "MaxLength", "lMeanDepth","lShorelineDevelopment", "Julian.day", "HypoThick")#lMinorAxisLength", "lFetch, "DRhypo", HT0712.hot.back

HTF0712.hot = HT0712.hot.back[,HTpred]
HTF0712.hot$Dynamic = sqrt(HTF0712.hot$area_km2)/HTF0712.hot$lMeanDepth
...
#Transformer l'epaisseur de l'hypo en proportion du lac
HTprop.pred = c("lat", "lon","area_km2", "elevation_m", "basinarea_km2", "chla_ugL", "NTL_umolL", "PTL_umolL", "DOC_umolL", "secchi_m", "color_PCU","WALA_ratio", "pct_forest", "pct_agric",  "nutrient_color", "Transp.index", "MaxLength", "lMeanDepth","lShorelineDevelopment", "Julian.day", "HypoThick","depthmax_m")#lMinorAxisLength", "lFetch, "DRhypo", 
...
BHpred = c("lat", "lon","area_km2", "elevation_m", "basinarea_km2", "chla_ugL", "NTL_umolL", "PTL_umolL", "DOC_umolL", "secchi_m", "color_PCU","WALA_ratio", "pct_forest", "pct_agric",  "nutrient_color", "Transp.index", "MaxLength", "lMeanDepth","lShorelineDevelopment", "Julian.day","DRhypo", "hypox", "depthmax_m")#lMinorAxisLength", "lFetch
...
#Regression logistique
set.seed(101)
train0712 = sample(1:nrow(BHF0712.back), 0.7*nrow(BHF0712.back))
test0712 = which(!1:nrow(BHF0712.back) %in% train0712)

BHF0712.lasso = BHF0712.back
...
# Model accuracy rate
observed.classes <- testdata$hypox
mean(predicted.classes == observed.classes) #0.72
coef(lasso.model)
...
BHF0712.hot$Dynamic = sqrt(BHF0712.hot$area_km2)/BHF0712.hot$lMeanDepth
