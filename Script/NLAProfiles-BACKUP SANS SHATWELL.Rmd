...
#Repeat for all lakes below 40°N
#Select lakes with corrected latitude >40°
allless40 = metadata0712[which(metadata0712$Corlat < 40),]
deep07.temp = unlist(strsplit(deep07, ".csv"))
deep12.temp = unlist(strsplit(deep12, ".csv"))

allless4007 = allless40[allless40$year==2007,]
metadata.less40deep07 = allless4007[match(deep07.temp, allless4007$site_id),]
indexNA07 = list()
for(i in 1:dim(metadata.less40deep07)[1])
{
  if(all(is.na(metadata.less40deep07[i,])))  indexNA07[[i]] = i
}
indexNA07 = unlist(indexNA07)
metadata.less40deep07 = metadata.less40deep07[-indexNA07,]
rm(allless4007)

allless4012 = allless40[allless40$year!=2007,]
metadata.less40deep12= allless4012[match(deep12.temp, allless4012$site_id),]
indexNA12 = list()
for(i in 1:dim(metadata.less40deep12)[1])
{
  if(all(is.na(metadata.less40deep12[i,])))  indexNA12[[i]] = i
}
indexNA12 = unlist(indexNA12)
metadata.less40deep12 = metadata.less40deep12[-indexNA12,]
rm(allless4012)

#Select correspoding filenames
deeplat07.hot = deep07[match(metadata.less40deep07$site_id, deep07.temp)] #649 lakes deeper than 2m and >40°N
deeplat12.hot = deep12[match(metadata.less40deep12$site_id, deep12.temp)] #599 lakes deeper than 2m and >40°N
...
#Hypolimnion
#calculate metalimnion strata for all lakes in 2007 and 2012
strata07.hot = home_strata_temp(deeplat07.hot, 2007)
strata12.hot = home_strata_temp(deeplat12.hot, 2012)

#Select those that have a hypolimnion
hypo07.hot = strata07.hot[,which(strata07.hot[3,] != -1 & strata07.hot[3,] != strata07.hot[4,])]
hypo12.hot = strata12.hot[,which(strata12.hot[3,] != -1 & strata12.hot[3,] != strata12.hot[4,])]

#Create binary response variable: w/ or w/o hypolimion
Binhypo07.hot = strata07.hot[1,]
Binhypo12.hot = strata12.hot[1,]
for(i in 1:length(Binhypo07.hot))
{
  Binhypo07.hot[i] = ifelse(strata07.hot[3,i] == -1 | strata07.hot[3,i] == strata07.hot[4,i], "0", "1")
}
for(i in 1:length(Binhypo12.hot))
{
  Binhypo12.hot[i] = ifelse(strata12.hot[3,i] == -1 | strata12.hot[3,i] == strata12.hot[4,i], "0", "1")
}
...
# O2sat07 = O2sat07[which(strata07[3,] != -1 & strata07[3,] != strata07[4,])]
# O2sat12 = O2sat12[which(strata12[3,] != -1 & strata12[3,] != strata12[4,])]
metadata.hypo07.hot = metadata.less40deep07[which(strata07.hot[3,] != -1 & strata07.hot[3,] != strata07.hot[4,]),]
metadata.hypo12.hot = metadata.less40deep12[which(strata12.hot[3,] != -1 & strata12.hot[3,] != strata12.hot[4,]),]

#Remove lakes w/o DO measurements
index07 = list()
for(i in 1:dim(hypo07.hot)[2])
{
  data = read.csv(paste0("../data/Preprocessing/2007/",colnames(hypo07.hot)[i], ".csv"), row.names = 1)
  if(all(is.na(data$DO))) index07[[i]] = i
}
...
index12 = list()
for(i in 1:dim(hypo12.hot)[2])
{
  data = read.csv(paste0("../data/Preprocessing/2012/",colnames(hypo12.hot)[i], ".csv"), row.names = 1)
  if(all(is.na(data$DO))) index12[[i]] = i
}

#O2sat07 = O2sat07[-index07]
hypo07.hot = hypo07.hot[,-index07]
metadata.hypo07.hot = metadata.hypo07.hot[-index07,]

#Calculate volumetric AOU
Area07.hot = metadata.hypo07.hot$area_km2*1000*1000
Area12.hot = metadata.hypo12.hot$area_km2*1000*1000
...
#Calculate hypolimnion temperature weighted mean
VolT07.hot = VolTemp(hypo07.hot, 2007, Area07.hot)
VolT12.hot = VolTemp(hypo12.hot, 2012, Area12.hot)

#Calculate sediment and volume to sediment ratio
SedVar07.hot = SedArea(hypo07.hot, 2007, Area07.hot)
SedVar12.hot = SedArea(hypo12.hot, 2012, Area12.hot)

#Create binary variable for hypoxia and anoxia
hypox07.hot = list()
for(i in c(1:dim(hypo07.hot)[2]))
{
  data = read.csv(paste0("../data/Preprocessing/2007/", 
                         colnames(hypo07.hot)[i], ".csv"), row.names = 1)
  if(min(data$DO, na.rm = T) <= 2) {hypox07.hot[[i]] = 1} else {hypox07.hot[[i]]=0}
}
...
for(i in c(1:dim(hypo07.hot)[2]))
{
  data = read.csv(paste0("../data/Preprocessing/2007/",
                         colnames(hypo07.hot)[i], ".csv"), row.names = 1)
  if(min(data$DO, na.rm = T) <= 0.5) {anox07.hot[[i]] = 1} else {anox07.hot[[i]]=0}
}

hypox12.hot = list()
for(i in c(1:dim(hypo12.hot)[2]))
{
  data = read.csv(paste0("../data/Preprocessing/2012/",
                         colnames(hypo12.hot)[i], ".csv"), row.names = 1)
  if(min(data$DO, na.rm = T) <= 2) {hypox12.hot[[i]] = 1} else {hypox12.hot[[i]]=0}
}
...
for(i in c(1:dim(hypo12.hot)[2]))
{
  data = read.csv(paste0("../data/Preprocessing/2012/",
                         colnames(hypo12.hot)[i], ".csv"), row.names = 1)
  if(min(data$DO, na.rm = T) <= 0.5) {anox12.hot[[i]] = 1} else {anox12.hot[[i]]=0}
}

hypox07.hot = as.factor(unlist(hypox07.hot))
anox07.hot = as.factor(unlist(anox07.hot))
hypox12.hot = as.factor(unlist(hypox12.hot))
anox12.hot = as.factor(unlist(anox12.hot))

#Combined dataframes
metadata.hypo07.hot = cbind(metadata.hypo07.hot, VolT=VolT07.hot, SedVar07.hot, hypox=hypox07.hot, anox=anox07.hot)#, RelO2=RelO207
metadata.hypo12.hot = cbind(metadata.hypo12.hot, VolT=VolT12.hot, SedVar12.hot, hypox=hypox12.hot, anox=anox12.hot)#, RelO2=RelO212
...
#For hot lakes
for(i in 1:length(metadata.less40deep07$depthmax_m)){
  if(metadata.less40deep07$depthmax_m[i] == metadata.less40deep07$sampled_depthmax_m[i]) metadata.less40deep07$depthmax_m = metadata.less40deep07$depthmax_m + 0.5
}


metadata.hypo12.hot = metadata.hypo12.hot[-28,]

metadata.hypo12.hot$depthmax_m = metadata.hypo12.hot$sampled_depthmax_m
for(i in 1:length(metadata.hypo12.hot$depthmax_m)){
  if(metadata.hypo12.hot$depthmax_m[i] < morphohypo12.hot$MaxDepth[i]) metadata.hypo12.hot$depthmax_m[i]  = morphohypo12.hot$MaxDepth[i]
}
for(i in 1:length(metadata.hypo12.hot$depthmax_m)){
  if(metadata.hypo12.hot$depthmax_m[i] == metadata.hypo12.hot$sampled_depthmax_m[i]) metadata.hypo12.hot$depthmax_m[i]  = metadata.hypo12.hot$depthmax_m[i] + 0.5
}

metadata.less40deep12.index = metadata.less40deep12$site_id %in% morphodeep12.hot$NLA_ID
metadata.less40deep12 = metadata.less40deep12[metadata.less40deep12.index,]
metadata.less40deep12$depthmax_m = metadata.less40deep12$sampled_depthmax_m + 0.5
for(i in 1:length(metadata.less40deep12$depthmax_m)){
  if(metadata.less40deep12$depthmax_m[i] < morphodeep12.hot$MaxDepth[i]) metadata.less40deep12$depthmax_m[i]  = morphodeep12.hot$MaxDepth[i]
}
...
#####For hot lakes#####
for(i in 1:length(metadata.hypo07.hot$depthmax_m)){
  if(metadata.hypo07.hot$depthmax_m[i] == metadata.hypo07.hot$sampled_depthmax_m[i]) metadata.hypo07.hot$depthmax_m = metadata.hypo07.hot$depthmax_m + 0.5
}
for(i in 1:length(metadata.hypo12.hot$depthmax_m)){
  if(metadata.hypo12.hot$depthmax_m[i] == metadata.hypo12.hot$sampled_depthmax_m[i]) metadata.hypo12.hot$depthmax_m = metadata.hypo12.hot$depthmax_m + 0.5
}
...
#For hot lakes
metadata.hypo07.hot$clear_to_bottom[which(is.na(metadata.hypo07.hot$clear_to_bottom))] = 0
for(i in 1:length(metadata.hypo07.hot$secchi_m)){
  if(is.na(metadata.hypo07.hot$secchi_m[i]) & metadata.hypo07.hot$clear_to_bottom[i]==1) metadata.hypo07.hot$secchi_m[i] = metadata.hypo07.hot$depthmax_m[i]
}

metadata.hypo12.hot$clear_to_bottom[which(is.na(metadata.hypo12.hot$clear_to_bottom))] = 0
for(i in 1:length(metadata.hypo12.hot$secchi_m)){
  if(is.na(metadata.hypo12.hot$secchi_m[i]) & metadata.hypo12.hot$clear_to_bottom[i]==1) metadata.hypo12.hot$secchi_m[i] = metadata.hypo12.hot$depthmax_m[i]
}
...
#For hot lakes
#DR = sqrt(surf[km²]) * surf[m²] / V[m³]
ConeVol07.hot = vector(length = length(Area07.hot))
for(i in 1:length(Area07.hot)){
  temp = approx.bathy(Zmax = metadata.hypo07.hot$depthmax_m[i], lkeArea = Area07.hot[i], zinterval = 0.1)
  ConeVol07.hot[i] = Trunc.cone(temp)
}

voldev07.hot = vector(length = length(Area07.hot))
for(i in 1:length(Area07.hot)){
  temp = approx.bathy(Zmax = metadata.hypo07.hot$depthmax_m[i], lkeArea = Area07.hot[i], Zmean = morphohypo07.hot$lMeanDepth[i], zinterval = 0.1, method = "voldev")
  voldev07.hot[i] = Trunc.cone(temp) }

#Hypolimnion volumes
Conehypo07.hot = matrix(nrow = length(Area07.hot),ncol=2)
colnames(Conehypo07.hot) = c("Conehypo07", "DRhypo07")
for(i in 1:length(Area07.hot)){
  temp = approx.bathy(Zmax = metadata.hypo07.hot$depthmax_m[i], lkeArea = Area07.hot[i], zinterval = 0.1)
   temp = temp[which(temp$depths >= hypo07.hot[3,i]),]
   Conehypo07.hot[i,1] = Trunc.cone(temp) 
   Conehypo07.hot[i,2] = (sqrt(temp[1,2]/1000/1000) * temp[1,2]/Conehypo07.hot[i,1]) }

Voldevhypo07.hot = matrix(nrow = length(Area07.hot), ncol=2)
colnames(Voldevhypo07.hot) = c("Voldevhypo07", "DRhypo07")
for(i in 1:length(Area07.hot)){
  temp = approx.bathy(Zmax = metadata.hypo07.hot$depthmax_m[i], lkeArea = Area07.hot[i], Zmean = morphohypo07.hot$lMeanDepth[i], zinterval = 0.1, method = "voldev")
   temp = temp[which(temp$depths >= hypo07.hot[3,i]),]
   Voldevhypo07.hot[i,1] = Trunc.cone(temp)
   Voldevhypo07.hot[i,2] = (sqrt(temp[1,2]/1000/1000) * temp[1,2]/Voldevhypo07.hot[i,1]) }

Voldevhypo12.hot = matrix(nrow = length(Area12.hot[-28]), ncol=2)
colnames(Voldevhypo12.hot) = c("Voldevhypo12", "DRhypo12")
Area12.hot = Area12.hot[-28]
hypo12.hot = hypo12.hot[,-28]
for(i in 1:length(Area12.hot)){
  temp = approx.bathy(Zmax = metadata.hypo12.hot$depthmax_m[i], lkeArea = Area12.hot[i], Zmean = morphohypo12.hot$lMeanDepth[i], zinterval = 0.1, method = "voldev")
   temp = temp[which(temp$depths >= hypo12.hot[3,i]),]
   Voldevhypo12.hot[i,1] = Trunc.cone(temp)
   Voldevhypo12.hot[i,2] = (sqrt(temp[1,2]/1000/1000) * temp[1,2]/Voldevhypo12.hot[i,1]) }
...
#For hot lakes
RAnox07.hot = vector(length = length(Area07.hot))
for(i in 1:length(Area07.hot)){
  data = read.csv(paste0("../data/Preprocessing/2007/",
                         colnames(hypo07.hot)[i], ".csv"), row.names = 1)
  anox.temp = (data$DO < 0.5)
  if(!any(anox.temp)) { RAnox07[i]=0 } else{
    temp = approx.bathy(Zmax = metadata.hypo07.hot$depthmax_m[i],
                        lkeArea = Area07.hot[i], Zmean = morphohypo07.hot$lMeanDepth[i],
                        zinterval = 0.1, method = "voldev")
    #temp = temp[which(temp$depths >= hypo07.hot[3,i]),] #pour avoir en % de l'hypolimnion
    Vol.tot = Trunc.cone(temp)
    temp = temp[which(temp$depths >= min(data[anox.temp,"depth"], na.rm = T)),]
  ...
  output.temp = Trunc.cone(temp)
  RAnox07.hot[i] = output.temp/Vol.tot
  }
}

RHypox07.hot = vector(length = length(Area07.hot))
for(i in 1:length(Area07.hot)){
  data = read.csv(paste0("../data/Preprocessing/2007/",
                         colnames(hypo07.hot)[i], ".csv"), row.names = 1)
  hypox.temp = (data$DO < 2)
  if(!any(hypox.temp)) { RHypox07.hot[i]=0 } else{
    temp = approx.bathy(Zmax = metadata.hypo07.hot$depthmax_m[i],
                        lkeArea = Area07.hot[i], Zmean = morphohypo07.hot$lMeanDepth[i],
                        zinterval = 0.1, method = "voldev")
    #temp = temp[which(temp$depths >= hypo07.hot[3,i]),]
    ...
    output.temp = Trunc.cone(temp)
    RHypox07.hot[i] = output.temp/Vol.tot
  }
}

#Calculate anoxia/hypoxia relative volume
RAnox07hypo.hot = vector(length = length(Area07.hot))
for(i in 1:length(Area07.hot)){
  data = read.csv(paste0("../data/Preprocessing/2007/",
                         colnames(hypo07.hot)[i], ".csv"), row.names = 1)
  ...
  if(!any(anox.temp)) { RAnox07.hot[i]=0 } else{
  ...
  output.temp = Trunc.cone(temp)
  RAnox07hypo.hot[i] = (output.temp)/(Vol.tot)
  }
}

RHypox07hypo.hot = vector(length = length(Area07.hot))
for(i in 1:length(Area07.hot)){
  data = read.csv(paste0("../data/Preprocessing/2007/",
                         colnames(hypo07.hot)[i], ".csv"), row.names = 1)
  hypox.temp = (data$DO < 2)
  if(!any(hypox.temp)) { RHypox07.hot[i]=0 } else{
    ...
    temp = temp[which(temp$depths >= min(data[hypox.temp,"depth"], na.rm = T)),]
    if(nrow(temp)==1) {
      RHypox07hypo.hot[i]=0
      next}
   
    output.temp = Trunc.cone(temp)
    RHypox07hypo.hot[i] = (output.temp)/(Vol.tot)
  }
}

RAnox12.hot = vector(length = length(Area12.hot))
for(i in 1:length(Area12.hot)){
  data = read.csv(paste0("../data/Preprocessing/2012/",
                         colnames(hypo12.hot)[i], ".csv"), row.names = 1)
  anox.temp = na.omit((data$DO < 0.5))
  if(!any(anox.temp)) { RAnox12.hot[i]=0 } else{
    temp = approx.bathy(Zmax = metadata.hypo12.hot$depthmax_m[i],
                        lkeArea = Area12.hot[i], Zmean = morphohypo12.hot$lMeanDepth[i],
                        zinterval = 0.1, method = "voldev")
    #temp = temp[which(temp$depths >= hypo12.hot[3,i]),]
    Vol.tot = Trunc.cone(temp)
    temp = temp[which(temp$depths >= min(data[anox.temp,"depth"], na.rm = T)),]
    ...
    output.temp = Trunc.cone(temp)
    RAnox12.hot[i] = output.temp/Vol.tot
  }
}

RHypox12.hot = vector(length = length(Area12.hot))
for(i in 1:length(Area12.hot)){
  data = read.csv(paste0("../data/Preprocessing/2012/",
                         colnames(hypo12.hot)[i], ".csv"), row.names = 1)
  hypox.temp = na.omit((data$DO < 2))
  ...
  { RHypox12.hot[i] = 999
    next }
  if(!any(hypox.temp)) { RHypox12.hot[i]=0 } else{
    temp = approx.bathy(Zmax = metadata.hypo12.hot$depthmax_m[i],
                        lkeArea = Area12.hot[i], Zmean = morphohypo12.hot$lMeanDepth[i],
                        zinterval = 0.05, method = "voldev")
    #temp = temp[which(temp$depths >= hypo12.hot[3,i]),]
    ...
    output.temp = Trunc.cone(temp)
    RHypox12.hot[i] = output.temp/Vol.tot
  }
}


RAnox12hypo.hot = vector(length = length(Area12.hot))
for(i in 1:length(Area12.hot)){
  data = read.csv(paste0("../data/Preprocessing/2012/",
                         colnames(hypo12.hot)[i], ".csv"), row.names = 1)
  anox.temp = na.omit((data$DO < 0.5))
  if(!any(anox.temp)) { RAnox12.hot[i]=0 } else{
    ...
    output.temp = Trunc.cone(temp)
    RAnox12hypo.hot[i] = (output.temp)/(Vol.tot)
  }
}

RHypox12hypo.hot = vector(length = length(Area12.hot))
for(i in 1:length(Area12.hot)){
  data = read.csv(paste0("../data/Preprocessing/2012/",
                         colnames(hypo12.hot)[i], ".csv"), row.names = 1)
  hypox.temp = na.omit((data$DO < 2))
  if(!any(hypox.temp)) { RHypox12.hot[i]=0 } else{
    ...
    if(nrow(temp)==1) {
      RHypox12hypo.hot[i]=0
      next}
    
    output.temp = Trunc.cone(temp)
    RHypox12hypo.hot[i] = (output.temp)/(Vol.tot)
  }
}

names(RAnox07.hot) <- names(RHypox07.hot) <- metadata.hypo07.hot$site_id
names(RAnox12.hot) <- names(RHypox12.hot) <- metadata.hypo12.hot$site_id
...
#For hot lakes
Binforest07.hot = merge(x = metadata.less40deep07, y = morpho07.hot, by = "site_id")
Binforest07.hot = merge(x = Binforest07.hot, y = MaxL.0712, by = "site_id",all.x =T)
#Fill missing lake length manually with google maps
Binforest07.hot = Binforest07.hot[-which(is.na(Binforest07.hot$MaxLength)),]

Temp.id07.hot = Binforest07.hot$site_id
Binforest07.hot = missForest(Binforest07.hot[,-c(1,2,3,10,11,12,13,14,36,37)])
Binforest07.hot = Binforest07.hot$ximp
Binforest07.hot[which(Binforest07.hot$secchi_m > Binforest07.hot$depthmax_m),"secchi_m"] = Binforest07.hot[which(Binforest07.hot$secchi_m > Binforest07.hot$depthmax_m),"depthmax_m"]
Binforest07.hot$Transparency = Binforest07.hot$secchi_m / Binforest07.hot$depthmax_m

Binhypo07.df.hot = as.data.frame(Binhypo07.hot)
Binhypo07.df.hot$site_id = names(Binhypo07.hot)
Binforest07.hot$site_id = Temp.id07.hot
Binforest07.hot = merge(Binforest07.hot, Binhypo07.df.hot, by = "site_id")

#Repeat with 2012
Binforest12.hot = merge(x = metadata.less40deep12, y = morpho12.hot, by = "site_id")
Binforest12.hot = merge(x = Binforest12.hot, y = MaxL.0712, by = "site_id",all.x =T)
#Remove the 3 Max Length NA that are rivers
Binforest12.hot = Binforest12.hot[-which(is.na(Binforest12.hot$MaxLength)),]


Temp.id12.hot = Binforest12.hot$site_id
Binforest12.hot = missForest(Binforest12.hot[,-c(1,2,3,10,11,12,13,14,36,37)])
Binforest12.hot = Binforest12.hot$ximp
Binforest12.hot[which(Binforest12.hot$secchi_m > Binforest12.hot$depthmax_m),"secchi_m"] = Binforest12.hot[which(Binforest12.hot$secchi_m > Binforest12.hot$depthmax_m),"depthmax_m"]
Binforest12.hot$Transparency = Binforest12.hot$secchi_m / Binforest12.hot$depthmax_m

Binforest12.hot$site_id = Temp.id12.hot
Binhypo12.df.hot = as.data.frame(Binhypo12.hot)
Binhypo12.df.hot$site_id = names(Binhypo12.hot)
Binforest12.hot = merge(Binforest12.hot, Binhypo12.df.hot, by = "site_id")
colnames(Binforest07.hot)[61] <- colnames(Binforest12.hot)[61] <-"Binhypo"
...
#For hot lakes
Bin0712.hot = cbind(rbind(Binforest07.hot, Binforest12.hot))
Bin0712.hot$NTL_umolL = Bin0712.hot$NTL_ugL/14.0067 #Transform into umol
Bin0712.hot$PTL_umolL = Bin0712.hot$PTL_ugL/30.973762 #Transform into umol
Bin0712.hot$DOC_umolL = Bin0712.hot$DOC_mgL/12.0107*1000

# deltaTpred = c("lat", "lon","area_km2", "elevation_m", "basinarea_km2", "chla_ugL", "NTL_umolL", "PTL_umolL", "DOC_umolL", "secchi_m", "color_PCU","WALA_ratio", "pct_forest", "pct_agric",  "nutrient_color", "Transparency", "lMeanDepth","lShorelineDevelopment", "depthmax_m","Julian.day", "deltaT")#"lMinorAxisLength", "lFetch", les valeurs sont aberantes
# 
...
#TEMPORARY FIX WALA
BF0712$WALA_ratio[1188] = BF0712$WALA_ratio[1188]/1000
BF0712$basinarea_km2[1188] = BF0712$basinarea_km2[1188]/1000

#BF0712.test = BF0712[,c(17,21)] #75% accuracy with only Zmean
...
confusionMatrix(rf.bt0712, BF0712[test0712,"Binhypo"]) #0.8808
...
par(mar = c(5,7,5,1)+.1)
barplot(r.bh0712.Gini,horiz = T, las = 1,cex.names =0.6)
...
RF.classif <- ifelse(rf_gridsearch$finalModel$votes[,1] > 0.5, 0,1)
Obs.classif <- BF0712$Binhypo
Col.code <- ifelse(RF.classif==Obs.classif, 1, 0)
...
#Create map of all lake used
ggplot(rf.hypo,aes(x=lon,y=lat))+
    geom_polygon(data = usa, aes(x=long, y = lat, group = group),fill="grey80")+
    coord_fixed(1.3)+
    geom_point(data=rf.hypo,aes(x=lon,y=lat),size=1.4,col="black")

#Create map with hypolimnion data
ggplot(rf.hypo,aes(x=lon,y=lat))+
    geom_polygon(data = usa, aes(x=long, y = lat, group = group),fill="grey80")+
    coord_fixed(1.3)+
    geom_point(data=rf.hypo,aes(x=lon,y=lat, shape=as.factor(RF.classif), color=as.factor(Col.code), fill = as.factor(Col.code), alpha = 0.1),size=1.4)+
    scale_shape_manual(values = c(25,21))+
    scale_color_manual(values=c("black",'black'))+
    scale_fill_manual(values=c("#FF0000",'chartreuse3'))
...
confusionMatrix(predicted.classes, observed.classes) #0.878
summary(step.logreg)


# par(mfrow=c(1,3))
# plot(BF0712$Transparency ~ BF0712$secchi_m)
# plot(BF0712$Transparency ~ BF0712$lMeanDepth)
...
BF0712.lasso = BF0712[,-19]
BF0712.lasso[,20] = as.numeric(BF0712.lasso[,20])-1
BF0712.lasso = cbind(scale(BF0712.lasso[,-c(15,21)]),BF0712.lasso[,c(15,21)])

traindata = BF0712.lasso[train0712,]
testdata = BF0712.lasso[test0712,]
# traindata[,22] = as.numeric(traindata[,22])-1
# testdata[,22] = as.numeric(testdata[,22])-1

x <- model.matrix(Binhypo~., traindata)[,-1]
y = as.numeric(traindata$Binhypo)-1
cv.lasso <- cv.glmnet(x, y, alpha = 1, family = "binomial")
model <- glmnet(x, y, alpha = 1, family = "binomial",
                lambda = cv.lasso$lambda.min)
coef(model)

x.test <- model.matrix(Binhypo ~., testdata)[,-1]
probabilities <- model %>% predict(newx = x.test)
predicted.classes <- as.factor(ifelse(probabilities > 0.5, "1", "0"))
observed.classes <- as.factor(testdata$Binhypo)
...
hypo.coef = varImp(lasso.model,lambda = 0.05)
hypo.coef = hypo.coef[order(hypo.coef$Overall, decreasing = T), ,drop = FALSE]
hypo.coef$Overall = hypo.coef$Overall/max(hypo.coef$Overall)*100
hypo.coef$y = c(1:length(hypo.coef$Overall))
hypo.coef = hypo.coef[c(1:8,23),]
fix(hypo.coef) #Change last y column by 9

plot(hypo.coef$y ~ hypo.coef$Overall,
     xlab = "Importance",
     ylab = "",
     las = 1,
     ...
     col = "blue",
     yaxt="n",
     ylim = rev(range(hypo.coef$y)))
#segments(x0 = 0, x1 = hypo.coef$Overall, y0 = hypo.coef$y, y1 = hypo.coef$y, lty = 1)
abline(v = 0)
text(x = 50, y = hypo.coef$y, row.names(hypo.coef), cex = 0.7,adj = 1)



#For hot lakes
BF0712.hot = Bin0712.hot[,Binhypopred]
BF0712.hot$Binhypo = as.factor(BF0712.hot$Binhypo)
BF0712.hot$DSR = sqrt(BF0712.hot$area_km2)/BF0712.hot$lMeanDepth
BF0712.hot = BF0712.hot[,-19] #Remove maxdepth because VIF is highest at ~40, but reduces max VIF to ~6 after this is ermoved


set.seed(101)
#Train and test datasets
train0712 = sample(1:nrow(BF0712.hot), 0.7*nrow(BF0712.hot))
test0712 = which(!1:nrow(BF0712.hot) %in% train0712)
...
#Random Forest on all variables
rf.bh0712.hot = randomForest(Binhypo~., data=BF0712.hot, subset = train0712, localImp = TRUE, ntree=1000)
rf.bt0712.hot = predict(rf.bh0712.hot, newdata = BF0712.hot[test0712,])
confusionMatrix(rf.bt0712.hot, BF0712.hot[test0712,"Binhypo"]) #0.8298

plot(rf.bt0712.hot ~ BF0712.hot[test0712,"Binhypo"],
     xlab = expression(Presence/absence~hypolimnion),
     # xlim = c(-4,4),
     # ylim = c(-2,3),
     ylab = expression(Predicted~presence/absence~hypolimnion),
...
rtparty0712.hot = ctree(Binhypo ~ ., data=BF0712.hot[test0712,], controls=cforest_control(mtry=NULL, mincriterion=3))
#pdf("../output/tree0712.pdf", width = 30, height = 15)
plot(rtparty0712.hot)

explain_forest(rf.bh0712.hot, interactions = TRUE, data = BF0712.hot[train0712,])
...
#Create de subdataset 
trainTask_BH.hot <- makeClassifTask(data = BF0712.hot[train0712,], target = "Binhypo")
testTask_BH.hot <- makeClassifTask(data = BF0712.hot[test0712,], target = "Binhypo")
#Create the Learner
learnerRF_BH.hot <- makeLearner("classif.cforest", predict.type = "prob",ntree=999)
learnerBART_BH.hot <- makeLearner("classif.bartMachine", predict.type = "prob")

# Create the models
modelRF_BH.hot <- mlr::train(learnerRF_BH.hot, task = trainTask_BH.hot)
modelBART_BH.hot <- mlr::train(learnerBART_BH.hot, task = trainTask_BH.hot)

#Validate
rRF_BH.hot=crossval(learnerRF_BH.hot, testTask_BH.hot, iters = 2L)
rBART_BH.hot=crossval(learnerBART_BH.hot, testTask_BH.hot, iters = 2L)

print(calculateConfusionMatrix(rRF_BH.hot$pred))
print(calculateConfusionMatrix(rBART_BH.hot$pred))

#Create prediction vectors
predRF_BH.hot = predict(modelRF_BH.hot, newdata = BF0712.hot[test0712,])
predBART_BH.hot = predict(modelBART_BH.hot, newdata = BF0712.hot[test0712,])
calculateROCMeasures(predRF_BH.hot)
calculateROCMeasures(predBART_BH.hot)
...
traindata = BF0712.hot[train0712,]
# traindata[,c(3:12, 17,18,20)] = scale(traindata[,c(3:12, 17,18,20)])
testdata = BF0712.hot[test0712,]
# testdata[,c(3:12, 17,18,20)] = scale(testdata[,c(3:12, 17,18,20)])
resp.train = as.numeric(traindata$Binhypo)-1

full.logreg.hot <- glm(resp.train ~., data = traindata[,-21], family = binomial)
step.logreg.hot <- full.logreg.hot %>% stepAIC(trace = FALSE)

probabilities <- full.logreg.hot %>% predict(testdata, type = "response")
predicted.classes <- as.factor(ifelse(probabilities > 0.5, "1", "0"))
observed.classes <- testdata$Binhypo
confusionMatrix(predicted.classes, observed.classes) #0.8085


probabilities <- step.logreg.hot %>% predict(testdata, type = "response")
predicted.classes <- as.factor(ifelse(probabilities > 0.5, "1", "0"))
observed.classes <- testdata$Binhypo
confusionMatrix(predicted.classes, observed.classes) #0.7943
summary(step.logreg.hot)

Okham.logreg.hot <- glm(resp.train ~basinarea_km2 +secchi_m + pct_agric + Transparency + Julian.day, data = traindata[,-21], family = binomial)
summary(Okham.logreg.hot)

# #avec données smote
# resp.train.smote = as.numeric(train0712.smote$Binhypo)-1
# full.logreg.hot.smote <- glm(resp.train.smote ~., data = train0712.smote[,-21], family = binomial)
# step.logreg.hot.smote <- full.logreg.hot.smote %>% stepAIC(trace = FALSE)
# 
# probabilities <- full.logreg.hot.smote %>% predict(testdata, type = "response")
# predicted.classes <- as.factor(ifelse(probabilities > 0.5, "1", "0"))
# observed.classes <- testdata$Binhypo
# confusionMatrix(predicted.classes, observed.classes) #0.8085
# 
# 
# probabilities <- step.logreg.hot.smote %>% predict(testdata, type = "response")
# predicted.classes <- as.factor(ifelse(probabilities > 0.5, "1", "0"))
# observed.classes <- testdata$Binhypo
# confusionMatrix(predicted.classes, observed.classes) #0.7943
# summary(step.logreg.hot)
...
#For hot lakes
####Foret aleatoire pour predire l'epaisseur de l'hypolimnion
HT07.hot = merge(x = metadata.hypo07.hot, y = morphohypo07.hot, by = "site_id")
HT12.hot = merge(x = metadata.hypo12.hot, y = morphohypo12.hot, by = "site_id")

metadata.hypo07.hot$DRhypo = Voldevhypo07.hot[,2]
metadata.hypo12.hot$DRhypo = Voldevhypo12.hot[,2]

metahypo07.merge.hot = metadata.hypo07.hot[,c(38,63:69)]
metahypo12.merge.hot = metadata.hypo12.hot[,c(38,63:69)]

Bin07.hot = Bin0712.hot[which(Bin0712.hot$year=="2007"),]
Bin12.hot = Bin0712.hot[which(Bin0712.hot$year=="2012"),]

HT07.hot = merge(metahypo07.merge.hot, Bin07.hot, by="site_id")
HT12.hot = merge(metahypo12.merge.hot, Bin12.hot, by="site_id")


HT0712.hot = rbind(HT07.hot, HT12.hot) #"RelO212" "VolT12"  "hypox12" "anox12" 
HT0712.hot.back = HT0712.hot
HTpred = c("lat", "lon","area_km2", "elevation_m", "basinarea_km2", "chla_ugL", "NTL_umolL", "PTL_umolL", "DOC_umolL", "secchi_m", "color_PCU","WALA_ratio", "pct_forest", "pct_agric",  "nutrient_color", "Transparency", "MaxLength", "lMeanDepth","lShorelineDevelopment", "Julian.day", "HypoThick")#lMinorAxisLength", "lFetch, "DRhypo", HT0712.hot.back

HTF0712.hot = HT0712.hot.back[,HTpred]
HTF0712.hot$DSR = sqrt(HTF0712.hot$area_km2)/HTF0712.hot$lMeanDepth


set.seed(101)
#Train and test datasets
train0712 = sample(1:nrow(HTF0712.hot), 0.6*nrow(HTF0712.hot))
test0712 = which(!1:nrow(HTF0712.hot) %in% train0712)
...
#Random Forest on all variables
rf.HTF0712.hot = randomForest(HypoThick~., data=HTF0712.hot, subset = train0712, localImp = TRUE,  ntree=1000)
rf.HTFt0712.hot = predict(rf.HTF0712.hot, newdata = HTF0712.hot[test0712,])

summary(lm(rf.HTFt0712.hot ~ HTF0712.hot[test0712,"HypoThick"]))
plot(rf.HTFt0712.hot ~ HTF0712.hot[test0712,"HypoThick"],
     xlab = expression(Hypolimnion~thickness),
     # xlim = c(-4,4),
     # ylim = c(-2,3),
     ylab = expression(Predicted~hypolimnion~thickness),
     las = 1)
rtparty.HT0712.hot = ctree(HypoThick ~ ., data=HTF0712.hot[test0712,], controls=cforest_control(mtry=NULL, mincriterion=3))
#pdf("../output/tree0712.pdf", width = 30, height = 15)
plot(rtparty.HT0712.hot)
# explain_forest(rf.HTF0712.hot, interactions = TRUE, data = HTF0712.hot)
...
#Create de subdataset 
trainTask_HT.hot <- makeRegrTask(data = HTF0712.hot[train0712,], target = "HypoThick")
testTask_HT.hot <- makeRegrTask(data = HTF0712.hot[test0712,], target = "HypoThick")
#Create the Learner
learnerRF_HT.hot <- makeLearner("regr.cforest", predict.type = "response",ntree=999)
learnerBART_HT.hot <- makeLearner("regr.bartMachine", predict.type = "response")

# Create the models
modelRF_HT.hot <- mlr::train(learnerRF_HT.hot, task = trainTask_HT.hot)
modelBART_HT.hot <- mlr::train(learnerBART_HT.hot, task = trainTask_HT.hot)

#Validate
rRF_HT.hot=crossval(learnerRF_HT.hot, testTask_HT.hot, iters = 2L)
rBART_HT.hot=crossval(learnerBART_HT.hot, testTask_HT.hot, iters = 2L)

#Create prediction vectors
predRF_HT.hot = predict(modelRF_HT.hot, newdata = HTF0712.hot[test0712,])
predBART_HT.hot = predict(modelBART_HT.hot, newdata = HTF0712.hot[test0712,])

predENS_HT.hot = (predRF_HT.hot$data$response+predBART_HT.hot$data$response)/2

HypoThick.col.hot = as.character(HTF0712.hot[test0712,"nutrient_color"])
HypoThick.col.hot[HypoThick.col.hot=="murky"] = "black"
par(mfrow=c(1,3))
plot(predRF_HT.hot$data$response~ HTF0712.hot[test0712,"HypoThick"],
      xlab = expression(Hypolimnion~thickness),
     ylab = expression(Predicted~hypolimnion~thickness),
     las = 1,
     pch = 16,
     col = HypoThick.col.hot,
     main = "cforest")
plot(predBART_HT.hot$data$response~ HTF0712.hot[test0712,"HypoThick"],
      xlab = expression(Hypolimnion~thickness),
     ylab = expression(Predicted~hypolimnion~thickness),
     las = 1,
     pch = 16,
     col = HypoThick.col.hot,
     main = "BART")
plot(predENS_HT.hot~ HTF0712.hot[test0712,"HypoThick"],
      xlab = expression(Hypolimnion~thickness),
     ylab = expression(Predicted~hypolimnion~thickness),
     las = 1,
     pch = 16,
...
summary(lm(predRF_HT.hot$data$response~ HTF0712.hot[test0712,"HypoThick"]))
summary(lm(predBART_HT.hot$data$response~ HTF0712.hot[test0712,"HypoThick"]))
summary(lm(predENS_HT.hot~ HTF0712.hot[test0712,"HypoThick"]))
...
#Transformer l'epaisseur de l'hypo en proportion du lac
HTprop.pred = c("lat", "lon","area_km2", "elevation_m", "basinarea_km2", "chla_ugL", "NTL_umolL", "PTL_umolL", "DOC_umolL", "secchi_m", "color_PCU","WALA_ratio", "pct_forest", "pct_agric",  "nutrient_color", "Transparency", "MaxLength", "lMeanDepth","lShorelineDevelopment", "Julian.day", "HypoThick","depthmax_m")#lMinorAxisLength", "lFetch, "DRhypo", 

RHTF0712.hot = HT0712.hot.back[,HTprop.pred]
RHTF0712.hot$HypoProp = RHTF0712.hot$HypoThick/RHTF0712.hot$depthmax_m
#RHTF0712$HypoProplog = log(HTF0712$HypoThick)/log(HTF0712$sampled_depthmax_m)
RHTF0712.hot = RHTF0712.hot[,-which(colnames(RHTF0712.hot)=="HypoThick")]
RHTF0712.hot = RHTF0712.hot[,-which(colnames(RHTF0712.hot)=="depthmax_m")]
#51-73

set.seed(101)
#Train and test datasets
train0712 = sample(1:nrow(RHTF0712.hot), 0.6*nrow(RHTF0712.hot))
test0712 = which(!1:nrow(RHTF0712.hot) %in% train0712)
...
#Random Forest on all variables
rf.RHTF0712.hot = randomForest(HypoProp~., data=RHTF0712.hot, subset = train0712, localImp = TRUE, ntree=1000)
rf.RHTFt0712.hot = predict(rf.RHTF0712.hot, newdata = RHTF0712.hot[test0712,])


summary(lm(rf.RHTFt0712.hot ~ RHTF0712.hot[test0712,"HypoProp"]))
HypoProp.col.hot = as.character(RHTF0712.hot[test0712,"nutrient_color"])
HypoProp.col.hot[HypoProp.col.hot=="murky"] = "black"
plot(rf.RHTFt0712.hot ~ RHTF0712.hot[test0712,"HypoProp"],
     xlab = expression(Relative~hypolimnion~thickness),
     # xlim = c(-4,4),
     # ylim = c(-2,3),
     ylab = expression(Predicted~relative~hypolimnion~thickness),
     las = 1,
     pch = 16,
     col = HypoProp.col.hot)
rtparty.RHT0712.hot = ctree(HypoProp ~ ., data=RHTF0712.hot[test0712,], controls=cforest_control(mtry=NULL, mincriterion=2))
#pdf("../output/tree0712.pdf", width = 30, height = 15)
plot(rtparty.RHT0712.hot)

# explain_forest(rf.RHTF0712.hot, interactions = TRUE, data = RHTF0712.hot)
...
#Create de subdataset 
trainTask_RHT.hot <- makeRegrTask(data = RHTF0712.hot[train0712,], target = "HypoProp")
testTask_RHT.hot <- makeRegrTask(data = RHTF0712.hot[test0712,], target = "HypoProp")
#Create the Learner
learnerRF_RHT.hot <- makeLearner("regr.cforest", predict.type = "response",ntree=999)
learnerBART_RHT.hot <- makeLearner("regr.bartMachine", predict.type = "response")

# Create the models
modelRF_RHT.hot <- mlr::train(learnerRF_RHT.hot, task = trainTask_RHT.hot)
modelBART_RHT.hot <- mlr::train(learnerBART_RHT.hot, task = trainTask_RHT.hot)

#Validate
rRF_RHT.hot=crossval(learnerRF_RHT.hot, testTask_RHT.hot, iters = 2L)
rBART_RHT.hot=crossval(learnerBART_RHT.hot, testTask_RHT.hot, iters = 2L)

#Create prediction vectors
predRF_RHT.hot = predict(modelRF_RHT.hot, newdata = RHTF0712.hot[test0712,])
predBART_RHT.hot = predict(modelBART_RHT.hot, newdata = RHTF0712.hot[test0712,])

predENS_RHT.hot = (predRF_RHT.hot$data$response+predBART_RHT.hot$data$response)/2

HypoProp.col.hot = as.character(RHTF0712.hot[test0712,"nutrient_color"])
HypoProp.col.hot[HypoProp.col.hot=="murky"] = "black"
par(mfrow=c(1,3))
plot(predRF_RHT.hot$data$response~ RHTF0712.hot[test0712,"HypoProp"],
      xlab = expression(Hypolimnion~Propness~(proportion)),
     ylab = expression(Predicted~hypolimnion~Propness~(proportion)),
     las = 1,
     pch = 16,
     col = HypoProp.col.hot,
     main = "cforest")
plot(predBART_RHT.hot$data$response~ RHTF0712.hot[test0712,"HypoProp"],
      xlab = expression(Hypolimnion~Propness~(proportion)),
     ylab = expression(Predicted~hypolimnion~Propness~(proportion)),
     las = 1,
     pch = 16,
     col = HypoProp.col.hot,
     main = "BART")
plot(predENS_RHT.hot~ RHTF0712.hot[test0712,"HypoProp"],
      xlab = expression(Hypolimnion~Propness~(proportion)),
     ylab = expression(Predicted~hypolimnion~Propness~(proportion)),
     las = 1,
     pch = 16,
     col = HypoProp.col.hot,
     main = "Ensemble")
summary(lm(predRF_RHT.hot$data$response~ RHTF0712.hot[test0712,"HypoProp"]))
summary(lm(predBART_RHT.hot$data$response~ RHTF0712.hot[test0712,"HypoProp"]))
summary(lm(predENS_RHT.hot~ RHTF0712.hot[test0712,"HypoProp"]))
...
#####################################BIN ANOX######################
# BApred = c("lat", "lon","area_km2", "elevation_m", "basinarea_km2", "chla_ugL", "NTL_umolL", "PTL_umolL", "DOC_umolL", "secchi_m", "color_PCU","WALA_ratio", "pct_forest", "pct_agric",  "nutrient_color", "Transparency", "lMeanDepth","lShorelineDevelopment", "depthmax_m","Julian.day", "DRhypo", "anox")#lMinorAxisLength", "lFetch
# 
...
confusionMatrix(rf.BHFt0712, BHF0712[test0712,"hypox"]) #0.7947
...
#Create df to map the results
#Assign RF value based on votes
RF.classif.hypox <- ifelse(rf_gridsearch.hypox$finalModel$votes[,1] > 0.5, 0,1)
Obs.classif.hypox <- BHF0712$hypox
Col.code.hypox <- ifelse(RF.classif.hypox==Obs.classif.hypox, 1, 0)
...
ggplot(rf.hypox,aes(x=lon,y=lat))+
    geom_polygon(data = usa, aes(x=long, y = lat, group = group),fill="grey80")+
    coord_fixed(1.3)+
    geom_point(data=rf.hypox,aes(x=lon,y=lat, shape=as.factor(RF.classif.hypox), color=as.factor(Col.code.hypox), fill = as.factor(Col.code.hypox), alpha = 0.1),size=1.4)+
    scale_shape_manual(values = c(25,21))+
    scale_color_manual(values=c("black",'black'))+
    scale_fill_manual(values=c("#FF0000",'Chartreuse3'))
...
for(j in 1:7){
  ...
  for(i in 1:25) {
    ...
    if(j ==1 | j==4 | j== 5 | j==7) eutro.testdata$DOC_umolL = BHF0712$DOC_umolL+7.69314*i
    if(j ==2 | j==4 | j== 6 | j==7) eutro.testdata$NTL_umolL = BHF0712$NTL_umolL+0.5240349*i
    if(j ==3 | j==5 | j== 6 | j==7) eutro.testdata$chla_ugL = BHF0712$chla_ugL+0.05756*i 
...
plot(output[,1] ~ seq(0,25,1),
     ...
     xlab = "Increase of 1st percentile",
     ylim = c(64,73))
...
#Regression logistique
set.seed(101)
train0712 = sample(1:nrow(BHF0712), 0.7*nrow(BHF0712))
test0712 = which(!1:nrow(BHF0712) %in% train0712)

BHF0712.lasso = BHF0712
BHF0712.lasso[,22] = as.numeric(BHF0712.lasso[,22])-1
BHF0712.lasso = cbind(scale(BHF0712.lasso[,c(1:14, 16:21,23)]), BHF0712.lasso[,c(15,22)])

traindata = BHF0712.lasso[train0712,]
testdata = BHF0712.lasso[test0712,]
# traindata[,22] = as.numeric(traindata[,22])-1
# testdata[,22] = as.numeric(testdata[,22])-1
...
mean(predicted.classes == observed.classes) #0.7413
confusionMatrix(predicted.classes, observed.classes)
plot(cv.lasso)
...
# Model accuracy rate
observed.classes <- as.factor(testdata$hypox)
mean(predicted.classes == observed.classes) #0.71
confusionMatrix(predicted.classes, observed.classes)
 coef(lasso.model)
hypox.coef = varImp(lasso.model,lambda = 0.05)
hypox.coef = hypox.coef[order(hypox.coef$Overall, decreasing = T), ,drop = FALSE]
hypox.coef$Overall = hypox.coef$Overall/max(hypox.coef$Overall)*100
hypox.coef$y = c(1:length(hypox.coef$Overall))
hypox.coef = hypox.coef[-c(15:22),]
fix(hypox.coef) #Change y values of bottom 2

plot(hypox.coef$y ~ hypox.coef$Overall,
     xlab = "Importance",
     ylab = "",
     las = 1,
     ...
     col = "blue",
     yaxt="n",
     ylim = rev(range(hypox.coef$y)))
#segments(x0 = 0, x1 = hypox.coef$Overall, y0 = hypox.coef$y, y1 = hypox.coef$y, lty = 1)
abline(v = 0)
text(x = 90, y = hypox.coef$y, row.names(hypox.coef), cex = 0.7,adj = 1)

#For hot lakes

BHF0712.hot = HT0712.hot[,BHpred] #BinHypoxForest BAF
BHF0712.hot$DSR = sqrt(BHF0712.hot$area_km2)/BHF0712.hot$lMeanDepth

set.seed(101)
#Train and test datasets
train0712 = sample(1:nrow(BHF0712.hot), 0.6*nrow(BHF0712.hot))
test0712 = which(!1:nrow(BHF0712.hot) %in% train0712)

#Random Forest on all variables
rf.BHF0712.hot = randomForest(hypox~., data=BHF0712.hot, subset = train0712, localImp = TRUE,ntree = 1000)
rf.BHFt0712.hot = predict(rf.BHF0712.hot, newdata = BHF0712.hot[test0712,])
confusionMatrix(rf.BHFt0712.hot, BHF0712.hot[test0712,"hypox"])

plot(rf.BHFt0712.hot ~ BHF0712.hot[test0712,"hypox"],
     xlab = expression(Hypoxia),
     # xlim = c(-4,4),
     # ylim = c(-2,3),
     ylab = expression(Predicted~hypoxia),
     las = 1)
rtparty.BHT0712.hot = ctree(hypox ~ ., data=BHF0712.hot[test0712,], controls=cforest_control(mtry=NULL, mincriterion=3))
#pdf("../output/tree0712.pdf", width = 30, height = 15)
plot(rtparty.BHT0712.hot)
# explain_forest(rf.BHF0712.hot, interactions = TRUE, data = BHF0712.hot[test0712,])
...
#Create de subdataset 
trainTask_BHx.hot <- makeClassifTask(data = BHF0712.hot[train0712,], target = "hypox")
testTask_BHx.hot <- makeClassifTask(data = BHF0712.hot[test0712,], target = "hypox")
#Create the Learner
learnerRF_BHx.hot <- makeLearner("classif.cforest", predict.type = "prob",ntree=999)
learnerBART_BHx.hot <- makeLearner("classif.bartMachine", predict.type = "prob")

# Create the models
modelRF_BHx.hot <- mlr::train(learnerRF_BHx.hot, task = trainTask_BHx.hot)
modelBART_BHx.hot <- mlr::train(learnerBART_BHx.hot, task = trainTask_BHx.hot)

#Validate
rRF_BHx.hot=crossval(learnerRF_BHx.hot, testTask_BHx.hot, iters = 10L)
rBART_BHx.hot=crossval(learnerBART_BHx.hot, testTask_BHx.hot, iters = 10L)
print(calculateConfusionMatrix(rRF_BHx.hot$pred))
print(calculateConfusionMatrix(rBART_BHx.hot$pred))

#Create prediction vectors
predRF_BHx.hot = predict(modelRF_BHx.hot, newdata = BHF0712.hot[test0712,])
predBART_BHx.hot = predict(modelBART_BHx.hot, newdata = BHF0712.hot[test0712,])

predENS_BHx.hot = predRF_BHx.hot
predENS_BHx.hot$prob.0 = (predRF_BHx.hot$data$prob.0+predBART_BHx.hot$data$prob.0)/2
predENS_BHx.hot$prob.1 = 1-predENS_BHx.hot$prob.0
predENS_BHx.hot$response = ifelse(predENS_BHx.hot$prob.1 >= predENS_BHx.hot$prob.0, 1, 0)

calculateROCMeasures(predRF_BHx.hot)
calculateROCMeasures(predBART_BHx.hot)
calculateROCMeasures(predENS_BHx.hot)
...
traindata.hot = BHF0712.hot[train0712,]
# traindata[,c(3:12, 17,18,20)] = scale(traindata[,c(3:12, 17,18,20)])
testdata.hot = BHF0712.hot[test0712,]
# testdata[,c(3:12, 17,18,20)] = scale(testdata[,c(3:12, 17,18,20)])
resp.train = as.numeric(traindata.hot$hypox)-1

full.logreg.hot <- glm(resp.train ~., data = traindata.hot[,-c(1,2,19,22)], family = binomial)
step.logreg.hot <- full.logreg.hot %>% stepAIC(direction = "backward", trace=F)

probabilities <- full.logreg.hot %>% predict(testdata.hot, type = "response")
predicted.classes <- as.factor(ifelse(probabilities > 0.5, "1", "0"))
observed.classes <- testdata.hot$hypox
confusionMatrix(predicted.classes, observed.classes) #0.5814

probabilities <- step.logreg.hot %>% predict(testdata.hot, type = "response")
predicted.classes <- as.factor(ifelse(probabilities > 0.5, "1", "0"))
observed.classes <- testdata.hot$hypox
confusionMatrix(predicted.classes, observed.classes) #05814
summary(step.logreg.hot)
